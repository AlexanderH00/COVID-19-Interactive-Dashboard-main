...
# Define the folder to store temporary plot images
image_folder = 'temp_images'
if not os.path.exists(image_folder):
    os.mkdir(image_folder)

# Define a counter to generate unique image filenames
image_counter = 0
...
# Callbacks to update the graphs based on user input and save them as images
@app.callback(
